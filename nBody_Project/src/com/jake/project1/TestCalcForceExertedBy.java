...
public class TestCalcForceExertedBy {
    ...
    public void checkCalcForceExertedBy() {
      ...
      assertEquals("Force exerted by p2 on p1 = 133.4 N", p1.calcForceExertedBy(p2), 133.4, 0.01);
      assertEquals("Force exerted by p3 on p1 = 6.67e-11 N", p1.calcForceExertedBy(p3), 6.67e-11, 1e-14);
  }
